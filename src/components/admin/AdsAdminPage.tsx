...
import styles from '@/app/admin/ads/ads.module.css';
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div className={styles.formGroup}>
                                            ...
                                            <input
                                                ...
                                                title="Duración en segundos que el anuncio será visible."
                                            />
                                        ...
                                        <div className={styles.formGroup}>
                                            ...
                                            <input
                                                ...
                                                disabled={editingAd?.placement !== 'recommendation'}
                                                title="Intervalo en segundos antes de que el anuncio reaparezca. Usa 0 para 'Solo al cargar'."
                                            />
