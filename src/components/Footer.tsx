                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                    <div className="space-y-6 flex flex-col items-center md:items-start text-center md:text-left">
                        ...
                        <div className="flex gap-4">
                            {settings.tiktok_url && (
                                <a className="w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center hover:bg-primary transition-colors" href={settings.tiktok_url} target="_blank" rel="noopener noreferrer" aria-label="TikTok">
                            ...
                            {settings.instagram_url && (
                                <a className="w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center hover:bg-primary transition-colors" href={settings.instagram_url} target="_blank" rel="noopener noreferrer" aria-label="Instagram">
                            ...
                            {settings.facebook_url && (
                                <a className="w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center hover:bg-primary transition-colors" href={settings.facebook_url} target="_blank" rel="noopener noreferrer" aria-label="Facebook">
                    ...
                    <div className="flex flex-col items-center md:items-start text-center md:text-left">
                        ...
                        <div className="flex w-full max-w-xs">
                            <input className="bg-slate-900 border-slate-800 rounded-l-lg focus:ring-primary focus:border-primary w-full text-sm p-4 h-12" placeholder="Tu email" type="email" />
                            <button className="bg-primary px-4 rounded-r-lg hover:bg-primary/90 transition-colors h-12 flex items-center justify-center">
